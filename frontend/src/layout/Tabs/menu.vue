<template>
	<div class="flex items-center">
		<ul class="flex m-0">
			...
			<li :class="{ active: $route.path.startsWith('/aliyun') }" @click="goTo('/aliyun')">
				<div class="bg-color"></div>
				<div class="flex bg-text">
			...
			<li :class="{ active: $route.path.startsWith('/toolbox') }" @click="goTo('/toolbox')">
				<div class="bg-color"></div>
				<div class="flex bg-text">
					<bt-icon name="toolbox" color="1f1f1f" size="16" class="z-1" />
					<span class="title">{{ pub.lang('工具箱') }}</span>
				</div>
			</li>
