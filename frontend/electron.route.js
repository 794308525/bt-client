...
const routes = {
	...
	aliyun: {
		...
		sms_sign_list: { title: '获取阿里云短信签名列表', method: 'ipc', path: 'controller.aliyun.sms_sign_list' },
		sms_sign_detail: { title: '获取阿里云短信签名详情', method: 'ipc', path: 'controller.aliyun.sms_sign_detail' },
		sms_template_list: { title: '获取阿里云短信模板列表', method: 'ipc', path: 'controller.aliyun.sms_template_list' },
		sms_template_detail: { title: '获取阿里云短信模板详情', method: 'ipc', path: 'controller.aliyun.sms_template_detail' },
		sms_send_statistics: { title: '获取阿里云短信发送统计', method: 'ipc', path: 'controller.aliyun.sms_send_statistics' },
		sms_send_details: { title: '获取阿里云短信发送明细', method: 'ipc', path: 'controller.aliyun.sms_send_details' },
